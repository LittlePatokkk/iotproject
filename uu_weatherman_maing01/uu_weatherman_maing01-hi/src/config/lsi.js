const Lsi = {
  appName: {
    cs: "Aplikace uuWeatherman",
    en: "Application uuWeatherman",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuWeatherman",
      en: "About application uuWeatherman",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuWeatherman.",
      en: "You can buy your own uuWeatherman.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuWeatherman.",
      en: "You don't have rights to initialize this uuWeatherman.",
    },
  },
